<template>
   <modal  name="add-machine"
     ...
     <div class="mt-8 p-4">
       ...
       <div class="flex flex-col md:flex-row">
                ...
                <div class="w-full mx-2 flex-1 svelte-1l8159u">
                    ...
                    <div class="bg-white my-2 p-1 flex border border-gray-200 rounded svelte-1l8159u">
                        <input type="number"  v-model="inputs.input_stand_norm1" placeholder="Stamdard norm (PCS)" class="p-1 px-2 appearance-none outline-none w-full text-gray-800"> </div>
                </div>
                <div class="w-full mx-2 flex-1 svelte-1l8159u">
            ...
            <div class="flex flex-col md:flex-row">
                ...
                <div class="w-full mx-2 flex-1 svelte-1l8159u">
                    ...
                    <div class="bg-white my-2 p-1 flex border border-gray-200 rounded svelte-1l8159u">
                        <input type="number" v-model="inputs.input_stand_norm2" placeholder="Stamdard norm (CBM)" class="p-1 px-2 appearance-none outline-none w-full text-gray-800"> </div>
                </div>
                <div class="w-full mx-2 flex-1 svelte-1l8159u">
            ...
            <div class="flex flex-col md:flex-row">
                ...
                <div class="w-full mx-2 flex-1 svelte-1l8159u">
                    ...
                    <div class="bg-white my-2 p-1 flex border border-gray-200 rounded svelte-1l8159u">
                        <input type="number" v-model="inputs.input_wmin" placeholder="Break minutes" class="p-1 px-2 appearance-none outline-none w-full text-gray-800"> </div>
                </div>
                <div class="w-full mx-2 flex-1 svelte-1l8159u">
     ...
     <div class="flex-auto flex flex-row-reverse">
          <button class="cursor-pointer bg-blue-600 hover:bg-blue-500 shadow-xl px-5 py-2 inline-block text-blue-100 hover:text-white rounded">Edit</button>
     </div>
     </div>
